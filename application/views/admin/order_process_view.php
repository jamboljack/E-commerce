        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box table-responsive">                    
                    <h4 class="m-t-0 header-title"><b>Order List [Process]</b></h4>
                    <br>
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo date("d-m-Y", strtotime($r->order_date_process)).'<br>'.substr($r->order_time,0,5).' WIB'; ?></td>
                                <td><?php echo ucwords(strtolower($r->user_name)); ?></td>
                                <td><?php echo ucwords(strtolower($r->user_address)); ?></td>
                                <td><?php echo $r->user_phone; ?></td>
                                <td>
                                    <a href="<?php echo site_url('admin/order_process/detaildata').'/'.$order_id; ?>">
