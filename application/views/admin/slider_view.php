                ...
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group"> 
                            ...
                            <input type="text" class="form-control" placeholder="Input Name" name="name" autocomplete="off" required autofocus> 
                        </div> 
                    </div>
                    <div class="col-md-12"> 
                        <div class="form-group">
                            ...
                            <div class="clearfix margin-top-10">
                                ...
                                <span>Resolution : 920 x 380 pixel (Landscape)</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group"> 
                            <label class="control-label">Name</label> 
                            <input type="text" class="form-control name" placeholder="Input Name" name="name" autocomplete="off" required> 
                        </div> 
                    </div>
                    <div class="col-md-12"> 
                        <div class="form-group">
                ...
                <div class="card-box table-responsive">                    
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo $r->slider_name; ?></td>
                                <td>
                                    <?php 
                                    if (empty($r->slider_image)) {
                                    ?>
                                    <img src="<?php echo base_url(); ?>img/avatar.png" width="50%">
                                    <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>img/slider/<?php echo $r->slider_image; ?>" width="100%">
                                    <?php } ?>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-warning btn-custom waves-effect waves-light btn-xs edit_button" data-toggle="modal" data-target="#editdata" data-id="<?php echo $r->slider_id; ?>" data-name="<?php echo $r->slider_name; ?>" title="Edit Data"><i class="icon-pencil"></i> Edit
                                    </button>
