    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <p class="text-muted page-title-alt">Selamat Datang, <?php echo ucwords(strtolower($this->session->userdata('nama'))); ?></p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-lg-3">
                <div class="card-box widget-box-1 bg-white">
                    ...
                    <p class="text-muted">Total Qty : <?php echo !empty($Qty1->Qty)?$Qty1->Qty:0; ?></p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-3">
                <div class="card-box widget-box-1 bg-white">
                    ...
                    <p class="text-muted">Total Qty : <?php echo !empty($Qty2->Qty)?$Qty2->Qty:0; ?></p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-3">
                <div class="card-box widget-box-1 bg-white">
                    ...
                    <p class="text-muted">Total Qty : <?php echo !empty($Qty3->Qty)?$Qty3->Qty:0; ?></p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-3">
                <div class="card-box widget-box-1 bg-white">
                    ...
                    <p class="text-muted">Total Qty : <?php echo !empty($Qty4->Qty)?$Qty4->Qty:0; ?></p>
                </div>
            </div>
        </div>
                        ...
                        <div class="portlet-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><a href="<?php echo site_url('admin/'.$link.'/detaildata'.'/'.$r->order_id); ?>" title="Click for Detail">#<?php echo $r->order_id; ?></a></td>
                                        <td>
